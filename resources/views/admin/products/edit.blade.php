...
@section('title', 'Edit Product | Day Dream Admin')
@section('page-title', 'Edit Product')
@section('page-subtitle', 'Perbarui data produk yang sudah tersedia.')
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                value="{{ old('name', $product->name) }}" placeholder="Example: Alcapone Donut">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="price"
                                    ...
                                    value="{{ old('price', $product->price) }}" placeholder="Example: 12000">
                        ...
                        <div class="mt-3">
                            ...
                            <textarea name="description" rows="5" class="form-control @error('description') is-invalid @enderror"
                                placeholder="Write product description here...">{{ old('description', $product->description) }}</textarea>
                        ...
                        <div class="form-check mt-3">
                            <input type="checkbox" name="is_best_seller" value="1" class="form-check-input"
                                id="isBestSeller" {{ old('is_best_seller', $product->is_best_seller) ? 'checked' : '' }}>
                ...
                <div class="col-lg-4">
                    <div class="form-section">
                        ...
                        <small class="helper-text">
                            Kosongkan jika tidak ingin mengganti gambar. Format: JPG, JPEG, PNG, WEBP. Max 2MB.
                        </small>
                    </div>
                </div>
            </div>
